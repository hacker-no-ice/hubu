...
The only supported agent-facing `hubu-unified-mcp` binary is distributed with
the shared release.
...
[the MCP transport guide](../mcp-transport.md) for the default client
configuration and approval boundaries.
