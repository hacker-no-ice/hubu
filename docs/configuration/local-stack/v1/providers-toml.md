...
among them at runtime without rewriting the stack profile. A mixed supported/raw
...
| Attribute | Value |
| --- | --- |
| Required | Sandbox and generic/composite live mode; optional for exactly one supported profile with no raw targets or pricing |
| Supplied by | Generated by Hubu for sandbox; chosen by the operator for live mode |
