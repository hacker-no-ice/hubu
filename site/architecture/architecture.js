...
const components = {
  ...
  gongbu: {
    ...
    copy: "Gongbu owns provider work end to end: credentials, pricing, Temporal workflows, submit-once generation, safe operation checkpoints, execution records, receipts, and artifacts. Hubu never opens Gongbu state.",
    diagram: [
