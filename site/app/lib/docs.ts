...
export const navGroups = [
  ...
  { label: "Core concepts", items: [["CLI administration", "cli"], ["Agent registration", "agent-registration"], ["Policy engine", "policy-engine"], ["Spend lifecycle", "spend-lifecycle"], ["Gongbu execution", "gongbu-execution"], ["Unified MCP", "unified-mcp"]] },
  { label: "Operations & runbooks", items: [["Local demo", "operations/local-demo"], ["Gongbu server", "operations/gongbu-server"], ["Gongbu sandbox", "operations/gongbu-sandbox"], ["Live provider operations", "operations/live-providers"], ["Managed FLUX.2 profile", "operations/managed-flux-profile"], ["Benchmarking", "operations/benchmarking"], ["Releases", "operations/releases"], ["Repository security", "operations/repository-security"]] },
