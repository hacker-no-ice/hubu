...
const components = {
  top: {
    ...
    responsibilities: [
      ...
      "A mixed Gemini Developer API and FLUX catalog keeps provider targets, opaque Keychain coordinates, execution attempts, and execution-bound artifacts distinct inside Gongbu, while Hubu and Gongbu continue to own separate databases and failure domains.",
  ...
  cli: {
    ...
    links: [sharedLinks.cli, sharedLinks.stackProviderProfile, sharedLinks.stackProviderDoctor, sharedLinks.stackLifecycle, sharedLinks.managedCredentialHandoff, sharedLinks.gongbuSupportedProfiles, sharedLinks.liveProviders, sharedLinks.managedFluxProfile, sharedLinks.localStack, sharedLinks.localStackAcceptance, sharedLinks.api, sharedLinks.registrationProtocol],
    nodes: [
  ...
  mcp: {
    ...
    links: [sharedLinks.unifiedMcp, sharedLinks.unifiedGovernedExecution, sharedLinks.unifiedResumeOperation, sharedLinks.unifiedMcpStdio, sharedLinks.unifiedMcpNotifications, sharedLinks.unifiedHubuCatalog, sharedLinks.unifiedHubuRouting, sharedLinks.unifiedOperationRegistry, sharedLinks.unifiedOperationWorker, sharedLinks.unifiedGongbuCatalog, sharedLinks.unifiedGongbuFixture, sharedLinks.unifiedMcpContract, sharedLinks.operationKeySkill, sharedLinks.operationKeyHelper, sharedLinks.liveProviders, sharedLinks.managedFluxProfile, sharedLinks.gongbuSupportedProfiles, sharedLinks.api, sharedLinks.gongbuApplication],
    zones: [
