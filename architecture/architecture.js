...
const components = {
  ...
  gongbu: {
    ...
    responsibilities: [
      ...
      "Accepts only schema-v2 pricing catalogs and freezes exact rational components plus normalized image-size selectors; the retired flat pricing shape is rejected.",
      ...
      "Settles actual cost or safely releases with the persisted execution agent through the v4 HTTP contract; ambiguous outcomes stay in reconciliation instead of causing blind provider retries.",
    ...
    nodes: [
      ...
      { id: "executionDb", label: "Gongbu SQLite", sub: "attribution + token replay", x: 340, y: 352, w: 210, h: 96, tone: "data", path: "crates/gongbu-api/src/execution/mod.rs" },
    ...
    edges: [
      ...
      ["workflow", "hubu", "finalize: persisted agent", { fromSide: "right", toSide: "left", waypoints: [{ x: 936, y: 158 }, { x: 936, y: 606 }], labelSegment: 1, labelDx: 120 }],
