const sharedLinks = {
  ...
  executionScope: ["Trusted execution scope", "docs/execution-scope.md"],
...
const components = {
  top: {
    ...
    responsibilities: [
      ...
      "Release archives contain four production binaries under one product version and source provenance identity; deprecated standalone MCP adapters are excluded.",
      ...
      "The unified MCP surface is the only supported agent-facing surface and routes approved Hubu governance and Gongbu execution/artifact tools through independently configured backend clients; standalone adapter source awaits HUB-98 removal.",
    ],
  ...
  release: {
    ...
    kind: "Component",
    copy:
      "The release workflow turns one exact main commit into target-specific archives containing four production binaries from the unified workspace; deprecated standalone MCP adapters are excluded.",
    responsibilities: [
  ...
  policy: {
    ...
    links: [sharedLinks.persistence, sharedLinks.api, sharedLinks.cli, sharedLinks.mcp, sharedLinks.executionScope, sharedLinks.scopeModel, sharedLinks.policyEngine, sharedLinks.policyModel, sharedLinks.policyCondition, ["Policy doc", "docs/policy-engine.md"]],
    nodes: [
  ...
  mcp: {
    ...
    responsibilities: [
      ...
      "Lists and routes exactly the 28 HUB-88-approved Hubu tools with standalone schemas, annotations, validation, trusted metadata, response shapes, and application errors; newer standalone-only tools stay excluded.",
      ...
      "Is the only supported surface written by `hubu init codex`; deprecated `hubu-mcp-server` and `gongbu-mcp` source remains only until HUB-98 and is excluded from packaging and generated configuration.",
...
const sidebarHighlights = {
  ...
  mcp: [
    ...
    "Deprecated standalone adapter source awaits HUB-98 removal and is not a supported surface.",
  ],
  agent: [
