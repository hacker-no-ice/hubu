...
const components = {
  top: {
    ...
    nodes: [
      ...
      { id: "workflow", label: "Provider execution", sub: "submit once + resume poll", x: 1010, y: 548, w: 250, h: 104, tone: "executor", path: "crates/gongbu-api/src/workflow.rs" },
  ...
  gongbu: {
    ...
    copy:
      "Gongbu starts without an execution principal. Its installation caller authenticates the service, while each new Hubu authorization supplies the account and agent snapshot. For asynchronous work, Gongbu submits once, checkpoints safe provider-operation evidence in its own SQLite database, and resumes read-only polling without moving credentials or provider payloads into Temporal or Hubu.",
    responsibilities: [
    ...
    links: [sharedLinks.gongbuOverview, sharedLinks.gongbuServer, sharedLinks.gongbuProviderConfig, sharedLinks.gongbuServerConfig, sharedLinks.gongbuApplication, sharedLinks.gongbuWorkflow, sharedLinks.gongbuTemporal, sharedLinks.gongbuExecution, sharedLinks.gongbuArtifact, sharedLinks.gongbuProvider, sharedLinks.gongbuPricing, sharedLinks.gongbuFlux, sharedLinks.gongbuHubu, sharedLinks.unifiedMcp, sharedLinks.gongbuConfig, sharedLinks.spendExecutor, sharedLinks.executionScope, sharedLinks.api],
    zones: [
    ...
    nodes: [
      ...
      { id: "gongbuApi", label: "Execution API", sub: "neutral; freeze target + price + input", x: 330, y: 104, w: 220, h: 92, tone: "executor", path: "crates/gongbu-api/src/http/mod.rs" },
