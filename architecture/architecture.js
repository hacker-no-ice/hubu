...
const components = {
  top: {
    ...
    nodes: [
      ...
      { id: "gongbu", label: "Gongbu HTTP API", sub: "execution + safe catalogs", x: 706, y: 570, w: 226, h: 104, tone: "executor", path: "crates/gongbu-api/src/http/mod.rs" },
    ...
    edges: [
      ...
      ["mcp", "gongbu", "discover/select + execute", { fromSide: "right", toSide: "left", waypoints: [{ x: 610, y: 430 }, { x: 610, y: 622 }], labelSegment: 1, labelDx: 42 }],
      ["api", "app", "govern"],
      ["app", "ledger", "persist"],
  ...
  mcp: {
    ...
    responsibilities: [
      ...
      "Publishes the six accepted gongbu_* catalog, target-discovery, execution, and artifact primitives, local hubu_operation_status, and router-owned hubu_submit_governed_execution and hubu_resume_operation with stable schemas, private continuation binding, public-handle correlation, and recursive redaction.",
    ...
    nodes: [
      ...
      { id: "tools", label: "Static router", sub: "41 tools; revision 6 + safe catalogs", x: 330, y: 92, w: 200, h: 96, tone: "surface", path: "crates/hubu-unified-mcp/src/lib.rs" },
