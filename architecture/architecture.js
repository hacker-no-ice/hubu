...
const components = {
  ...
  mcp: {
    ...
    responsibilities: [
      ...
      "Exposes only the public operation handle through hubu_operation_status; acknowledged work is never replacement-safe, and adapter reconciliation exhaustion terminates as failed while Gongbu retains its independent unresolved financial record.",
      ...
      "Returns the stable public handle with exact-redelivery guidance; ambiguous results must reuse the same harness call identity and never become replacement spend calls.",
