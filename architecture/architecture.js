...
const components = {
  top: {
    ...
    responsibilities: [
      ...
      "SQLite-backed records preserve users, agents, advisory spending targets, budgets, policies, payments, and ledger entries.",
    ],
  ...
  api: {
    ...
    nodes: [
      ...
      { id: "governance", label: "Governance DB", sub: "policy/target/budget", x: 804, y: 180, w: 196, h: 84, tone: "data" },
  ...
  budget: {
    ...
    responsibilities: [
      ...
      "Reserves, settles, releases, keeps retryable failures frozen, and expires one budget hold per spend decision for wallet payments and external executors.",
    ...
    nodes: [
      ...
      { id: "reserve", label: "Reserve hold", sub: "one agent budget", x: 420, y: 248, w: 210, h: 92, tone: "core" },
