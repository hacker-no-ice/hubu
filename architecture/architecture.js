...
const components = {
  ...
  mcp: {
    ...
    nodes: [
      ...
      { id: "tools", label: "Static router", sub: "39 tools; routing revision 4", x: 330, y: 92, w: 200, h: 96, tone: "surface", path: "crates/hubu-unified-mcp/src/lib.rs" },
    ...
    edges: [
      ...
      ["tools", "hubuClient", "review + budget versions"],
