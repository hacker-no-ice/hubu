...
const components = {
  top: {
    ...
    responsibilities: [
      ...
      "The clean-environment canary composes the real stack lifecycle, governed Hubu-to-Gongbu contract, and deterministic Gongbu HTTP/Temporal/artifact runtime without admitting fixture providers to the production server.",
  ...
  cli: {
    ...
    responsibilities: [
      ...
      "Ships a one-command acceptance canary that verifies lifecycle, governed deterministic execution, Temporal workflow discovery, artifact retrieval, restart persistence, and graceful shutdown without live provider spend.",
...
const sidebarHighlights = {
  ...
  cli: [
    ...
    "The acceptance canary proves lifecycle plus deterministic workflow and artifact recovery without live spend.",
