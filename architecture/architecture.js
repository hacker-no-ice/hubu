...
const components = {
  ...
  budget: {
    ...
    nodes: [
      ...
      { id: "periods", label: "Logical budget", sub: "stable id + half-open period", x: 420, y: 76, w: 210, h: 92, tone: "core" },
      ...
      { id: "store", label: "Governance store", sub: "versions + balance + receipts", x: 780, y: 282, w: 230, h: 96, tone: "data" },
    ...
    edges: [
      ...
      ["advisory", "store", "warn"],
      ["periods", "store", "v1 + current pointer"],
