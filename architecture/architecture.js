...
const components = {
  ...
  app: {
    ...
    responsibilities: [
      ...
      "Creates and looks up executor claims, derives the expired reconciliation queue, and coordinates executor or human finalization through one atomic repository boundary.",
    ...
    nodes: [
      ...
      { id: "persist", label: "Governance store", sub: "atomic claim state", x: 798, y: 188, w: 238, h: 98, tone: "data", path: "crates/hubu-core/src/persistence.rs" },
  ...
  budget: {
    ...
    nodes: [
      ...
      { id: "reconcile", label: "Human reconciliation", sub: "provider ref + evidence", x: 780, y: 500, w: 230, h: 96, tone: "human", path: "crates/hubu-core/src/app/executor_claim.rs" },
    ],
    edges: [
