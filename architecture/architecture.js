...
const components = {
  ...
  policy: {
    ...
    links: [sharedLinks.persistence, sharedLinks.api, sharedLinks.cli, sharedLinks.mcp, sharedLinks.policyEngine, sharedLinks.policyModel, sharedLinks.policyCondition, ["Policy doc", "docs/policy-engine.md"]],
    nodes: [
      ...
      { id: "request", label: "SpendRequest", sub: "amount/currency/context", x: 54, y: 412, w: 210, h: 90, tone: "agent" },
      { id: "validate", label: "Validate + evaluate", sub: "typed deterministic rules", x: 390, y: 412, w: 218, h: 90, tone: "core" },
