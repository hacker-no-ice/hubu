...
const components = {
  ...
  gongbu: {
    ...
    responsibilities: [
      ...
      "Separates authenticated polling from delivery: only literal approved API origins receive `x-key`, while ephemeral HTTPS `delivery.<region>.bfl.ai` links—including verified `delivery.us2.bfl.ai`—are fetched immediately without provider credentials and are never logged or persisted.",
