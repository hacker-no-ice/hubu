...
const components = {
  ...
  mcp: {
    ...
    responsibilities: [
      ...
      "Marks dispatch before Hubu mutation, stores monotonic terminal results and the sanitized replay payload separately from decision and continuation columns, recursively removes operation_key from every agent-facing response location, and erases terminal private keys.",
    ...
    nodes: [
      ...
      { id: "operationRegistry", label: "Operation registry", sub: "identity + replay + handle", x: 650, y: 334, w: 200, h: 96, tone: "data", path: "crates/hubu-unified-mcp/src/operation_registry.rs" },
