...
const components = {
  ...
  cli: {
    ...
    responsibilities: [
      ...
      "Requires one distinct opaque Keychain credential alias per provider plus explicit maximum-spend, live-spend acknowledgement, and an immutable composite catalog version.",
