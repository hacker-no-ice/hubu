...
const components = {
  ...
  gongbu: {
    ...
    nodes: [
      ...
      { id: "contract", label: "Provider contract source", sub: "FLUX contract + Gemini target", x: 45, y: 730, w: 205, h: 92, tone: "data", path: "contracts/provider-contracts-v1.json" },
  ...
  cli: {
    ...
    links: [sharedLinks.cli, sharedLinks.stackProviderContract, sharedLinks.stackProviderDoctor, sharedLinks.stackLifecycle, sharedLinks.managedCredentialHandoff, sharedLinks.gongbuProviderContracts, sharedLinks.liveProviders, sharedLinks.fluxProviderContract, sharedLinks.localStack, sharedLinks.localStackAcceptance, sharedLinks.api, sharedLinks.registrationProtocol],
    nodes: [
