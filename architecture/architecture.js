...
const components = {
  ...
  agent: {
    ...
    responsibilities: [
      ...
      "Synchronizes decisions submitted through unified MCP or the CLI; approved work becomes resume_required and hubu_resume_operation replays only the stored Hubu intent, binding stored execution intent only for governed work, while denial remains terminal without Gongbu or provider work.",
