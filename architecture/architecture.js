...
const components = {
  ...
  mcp: {
    ...
    responsibilities: [
      ...
      "Publishes and routes the four accepted gongbu_* execution and artifact tools with stable schema, private continuation binding, public-handle correlation, recursive redaction, and no ambiguous retry behavior.",
      ...
      "Binds each allowed auth_token_id to exactly one canonical Gongbu create intent before backend access, persists Gongbu execution identity plus lifecycle state, and fails closed on changed intent, spoofed protected controls, or mismatched returned identity.",
    ...
    links: [sharedLinks.unifiedMcp, sharedLinks.unifiedMcpStdio, sharedLinks.unifiedMcpNotifications, sharedLinks.unifiedHubuCatalog, sharedLinks.unifiedHubuRouting, sharedLinks.unifiedOperationRegistry, sharedLinks.unifiedGongbuCatalog, sharedLinks.unifiedGongbuFixture, sharedLinks.unifiedMcpContract, sharedLinks.api, sharedLinks.gongbuApplication],
    zones: [
    ...
    nodes: [
      ...
      { id: "operationRegistry", label: "Operation registry", sub: "auth continuation + execution state", x: 650, y: 334, w: 200, h: 96, tone: "data", path: "crates/hubu-unified-mcp/src/operation_registry.rs" },
    ...
    edges: [
      ...
      ["operationRegistry", "gongbuClient", "bind + verify", { fromSide: "bottom", toSide: "top" }],
