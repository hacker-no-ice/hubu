...
const components = {
  top: {
    ...
    nodes: [
      ...
      { id: "cli", label: "Hubu CLI", sub: "profile doctor + catalog", x: 340, y: 110, w: 230, h: 96, tone: "surface" },
      { id: "mcp", label: "Unified MCP", sub: "governed path + safe catalog", x: 340, y: 382, w: 230, h: 96, tone: "surface", path: "crates/hubu-unified-mcp/src/lib.rs" },
      ...
      { id: "gongbu", label: "Gongbu HTTP API", sub: "execution + sanitized catalog", x: 706, y: 570, w: 226, h: 104, tone: "executor", path: "crates/gongbu-api/src/http/mod.rs" },
  ...
  gongbu: {
    ...
    edges: [
      ["agent", "gongbuApi", "execution / catalog request", { labelDy: -65 }],
  ...
  mcp: {
    ...
    viewBox: "0 0 1280 760",
    copy:
      "The agent harness launches one default stdio server. The router offers bounded governed submission plus public-handle resume: primitive resume is Hubu-only, governed resume can continue stored Gongbu intent, and completed operations replay from the local registry. It also routes Gongbu's authenticated, sanitized managed-provider catalog without exposing credential coordinates or invoking a provider. Governance, provider execution, backend storage, credentials, artifacts, and failures remain with their owners.",
    responsibilities: [
      ...
      "Publishes the five accepted gongbu_* catalog, execution, and artifact primitives, local hubu_operation_status, and router-owned hubu_submit_governed_execution and hubu_resume_operation with stable schemas, private continuation binding, public-handle correlation, and recursive redaction.",
    ...
    nodes: [
      ...
      { id: "tools", label: "Static router", sub: "40 tools; revision 5 + provider catalog", x: 330, y: 92, w: 200, h: 96, tone: "surface", path: "crates/hubu-unified-mcp/src/lib.rs" },
      ...
      { id: "gongbuClient", label: "Gongbu client", sub: "execution + sanitized catalog", x: 650, y: 486, w: 200, h: 96, tone: "executor", path: "crates/hubu-unified-mcp/src/gongbu/transport.rs" },
      ...
      { id: "api", label: "Gongbu HTTP API", sub: "validated catalog + execution", x: 974, y: 528, w: 224, h: 104, tone: "executor", path: "crates/gongbu-api/src/http/mod.rs" },
    ],
    edges: [
      ...
      ["tools", "gongbuClient", "catalog / reads / artifacts", { fromSide: "bottom", toSide: "top", waypoints: [{ x: 430, y: 350 }, { x: 750, y: 350 }], labelSegment: 1 }],
