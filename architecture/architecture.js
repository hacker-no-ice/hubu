...
const components = {
  ...
  budget: {
    ...
    responsibilities: [
      ...
      "Finalizes claim, token, hold, and budget balance in one immediate SQLite transaction while leaving expired claims frozen for reconciliation.",
    ...
    nodes: [
      ...
      { id: "executor", label: "Executor claim", sub: "lease + execution ID", x: 76, y: 548, w: 238, h: 92, tone: "executor", path: "docs/spend-executor-contract.md" },
  ...
  gongbu: {
    ...
    responsibilities: [
      ...
      "Claims the token with a stable executor execution ID before irreversible billable vendor work.",
