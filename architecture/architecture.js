...
const components = {
  ...
  budget: {
    ...
    responsibilities: [
      ...
      "Treats every non-revoked budget as overlap-blocking for the same agent and currency, allows revocation with outstanding holds, and preserves the existing replacement contract by creating a separate forward-looking logical budget at revision 1.",
