...
pub const SERVER_CONFIG_SCHEMA_VERSION: u32 = 3;
pub const HUBU_EXECUTOR_CONTRACT: &str = "hubu-spend-executor-v4.3";
...
mod tests {
    ...
    fn safe_metadata_is_complete() {
        ...
        assert_eq!(info.server_config_schema_version, 3);
        assert_eq!(info.hubu_executor_contract, "hubu-spend-executor-v4.3");
    }
}
