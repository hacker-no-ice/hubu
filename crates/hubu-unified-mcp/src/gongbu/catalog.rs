...
pub(super) fn tool_definitions() -> Vec<Value> {
    ...
    vec![
        ...
        json!({"name":"gongbu_create_execution","description":"Continue one authorized normalized operation into one Gongbu execution using its opaque continuation identifier and an approved target_id returned by gongbu_list_execution_targets.","inputSchema":{"type":"object","additionalProperties":false,"required":["schema_version","spend_auth_token_id","input","input_schema_version","target_id"],"properties":create_properties}}),
        json!({"name":"gongbu_get_provider_catalog","description":"Get the production-validated provider contract catalog, including frozen pricing, capability policies, and non-network readiness evidence.","inputSchema":{"type":"object","additionalProperties":false,"properties":{}},"annotations":{"readOnlyHint":true,"destructiveHint":false,"idempotentHint":true,"openWorldHint":false}}),
