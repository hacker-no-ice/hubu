...
ALLOW_OUTPUT="$(hubu spend --agent-id "${AGENT_ID}" --amount 20 --reason "Purchase API credits")"
...
FAILED_OUTPUT="$(hubu spend --agent-id "${AGENT_ID}" --amount 15 --reason "Failed merchant payout" --merchant fail)"
